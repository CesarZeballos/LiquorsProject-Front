...
const Dashboard = () => {
  ...
  const [searchBar, setSearchBar] = useState("info")
  ...
  return <div className="mx-large mt-small">
    ...
    <div className="flex flex-row gap-6 mt-6">
      <div className="flex flex-col pt-5 bg-greyVivino gap-6 p-6 rounded">
              <button className="buttonSecondary hover:cursor-pointer" value="info" onClick={HandlerSearchBar}>Datos personales</button>
